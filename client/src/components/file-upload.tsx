    ...
    <div className="w-full" {...getRootProps()}>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center">
          <p className="relative z-20 font-[family-name:var(--font-geist-mono)] font-bold text-neutral-300 text-base">
            Upload file
          </p>
          <p className="relative z-20 font-[family-name:var(--font-geist-mono)] font-normal text-center text-neutral-400 text-base mt-2">
